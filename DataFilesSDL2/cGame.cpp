...
void cGame::initialise(SDL_Window* theSDLWND, SDL_Renderer* theRenderer)
{
	...
	theAreaClicked = { 0, 0 };
	// Store the textures
	textureName = { "tile1", "tile2", "tile3", "tile4", "tile5","tile6","theBackground"};
	texturesToUse = { "Images/Tiles/1.png", "Images/Tiles/2.png", "Images/Tiles/3.png", "Images/Tiles/4.png", "Images/Tiles/5.png", "Images/Tiles/6.png", "Images/Bkg/bkg.png"};
		...
		case PLAYING:
		{
			...
			if (theGameState == SAVEMAP)
			{
				...
				else
				{
					...
					MessageBox(NULL, "File Saved", "File Saved", MB_OK|MB_SYSTEMMODAL);
